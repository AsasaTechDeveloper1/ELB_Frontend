...
export default function DamageReportPage() {
  ...
  // Save damage with multiple images
  const saveDamage = async () => {
    ...
    // All files under the same field name: "files"
    files.forEach(file => {
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="flex justify-end space-x-3 pt-3 border-t">
                ...
                {modalMode === 'add' && (
                  <button
                    onClick={saveDamage}
                    className="px-6 py-2 text-sm bg-[#004051] text-white hover:bg-[#006172] rounded-md font-medium transition shadow-md"
                  >
                    Save Damage
                  </button>
                )}
