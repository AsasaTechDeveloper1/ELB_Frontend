    ...
    <div className="space-y-6">
      <div className="text-sm">
        <div className="bg-white text-gray-800 p-6 rounded-xl border border-gray-200 w-full shadow-sm mb-4">
          <table className="w-full table-fixed border border-gray-300 text-sm rounded overflow-hidden">
            <thead>
            ...
            <tbody>
              {[
                ...
                <tr className="border" key={i}>
                  ...
                  <td className="p-2">
                    <input type="text" placeholder="Type here..." className="w-full px-2 py-1 border border-gray-300 rounded focus:ring focus:ring-[#004051]/30" />
                  </td>
              ...
              {[
                ...
                <tr className="border" key={index}>
                  ...
                  <td className="p-2">
                    <input type="text" placeholder="-" className="w-full px-2 py-1 border border-gray-300 rounded focus:ring focus:ring-[#004051]/30" />
                  </td>
                </tr>
              ))}
              <tr className="border">
                <td className="p-2 font-medium text-[#004051]">
                  Supplier
                  <input type="text" placeholder="Enter supplier..." className="w-full mt-1 px-2 py-1 border border-[#004051] rounded focus:ring focus:ring-[#004051]/30" />
                </td>
                <td className="p-2 font-medium text-[#004051]">
                  Receipts
                  <input type="text" placeholder="Enter receipts..." className="w-full mt-1 px-2 py-1 border border-[#004051] rounded focus:ring focus:ring-[#004051]/30" />
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="bg-white text-gray-800 p-6 rounded-xl border border-gray-200 w-full shadow-sm space-y-4">
          <table className="w-full border-collapse text-sm rounded border border-gray-300">
            <tbody>
              <tr className="bg-[#004051] text-white">
              ...
              <tr>
                ...
                {[0, 1].map((i) => (
                  <td className="p-2 border" key={`water-${i}`}>
                    <input type="text" placeholder="Type here..." className="w-full border border-gray-300 rounded px-2 py-1 focus:ring focus:ring-blue-100" />
                  </td>
                ))}
                <td className="p-2 border"></td>
              </tr>
              <tr>
                <td className="p-2 text-center bg-[#004051] text-white border" colSpan={3}>GROUND DE - ICING</td>
              ...
              <tr>
                ...
                <td colSpan={2} className="p-2 border">
                  <div className="flex flex-col sm:flex-row gap-2">
                    <input type="text" placeholder="Mix" className="w-full sm:w-1/2 border border-gray-300 rounded px-2 py-1 focus:ring focus:ring-blue-100" />
                    <input type="time" className="w-full sm:w-1/2 border border-gray-300 rounded px-2 py-1 focus:ring focus:ring-blue-100" />
                  </div>
                </td>
              </tr>
            </tbody>
